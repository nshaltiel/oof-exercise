        ...
        {open && (
          <>
            ...
            <motion.div
              ...
              className="absolute left-0 top-12 z-50 bg-white rounded-2xl shadow-xl border p-4 w-72"
            >
              <h3 className="font-bold text-lg mb-3">הגדרות</h3>
              ...
              <div className="mb-4">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    onClick={handleCopy}
                    className="text-sm bg-[#6c5ce7] text-white px-3 py-2 rounded-lg hover:bg-[#5b4bd5]"
                  >
                    {copied ? '✓' : 'העתק'}
                  </button>
                </div>
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 bg-[#25D366] text-white py-2 rounded-lg mb-4 hover:bg-[#1da851] transition-colors"
              >
